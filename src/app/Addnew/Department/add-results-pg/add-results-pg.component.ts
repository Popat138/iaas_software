...
@Component({
  selector: 'app-add-results-pg',
  templateUrl: './add-results-pg.component.html',
  styleUrls: ['./add-results-pg.component.scss']
})
export class AddResultsPgComponent implements OnInit {
...
constructor(
  ...
  public data : any,
  public dialogRef: MatDialogRef<AddResultsPgComponent>,
...
this.service.postData("/pg-result/program/" + this.program.programId, data).subscribe((res: any) => {
console.log(res);
}, (err: any) => {
