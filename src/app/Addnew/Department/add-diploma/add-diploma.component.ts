...
export class AddDiplomaComponent implements OnInit{
  ...
  constructor(
    ...
    public data : any,
    public dialogRef: MatDialogRef<AddDiplomaComponent>,
  ...
  this.service.getUserWithUserId().subscribe((user: any) => {
    ...
    this.service.postData("/diploma-program/program/"+ this.program.programId +"/department/" + user.hod.department.id, data).subscribe((res: any) => {
      console.log(res);
