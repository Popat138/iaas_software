...
@Component({
  selector: 'app-add-one-time-form',
  templateUrl: './add-one-time-form.component.html',
  styleUrls: ['./add-one-time-form.component.scss']
})
export class AddOneTimeFormComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<AddOneTimeFormComponent>,
  ...
  //   return this.qualifications.controls;
  // }

  // createqualifications(): FormGroup {
  //   return this.fb.group({
  //     degree:this.fb.control('',Validators.required),
  //     university: this.fb.control({value: '', disabled: true},Validators.required),
  //     y_of_pass:this.fb.control('',Validators.required),
  //     specialization: this.fb.control({value: '', disabled: true},Validators.required),
  //     grade: this.fb.control('',Validators.required),
  ...
  //   this.qualifications = this.Form.get('qualifications') as FormArray;
  //   this.qualifications.push(this.createqualifications());
  // }
