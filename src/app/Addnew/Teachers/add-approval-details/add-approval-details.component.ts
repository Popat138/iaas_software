...
@Component({
  selector: 'app-add-approval-details',
  templateUrl: './add-approval-details.component.html',
  styleUrls: ['./add-approval-details.component.scss']
})
export class AddApprovalDetailsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<AddApprovalDetailsComponent>
  ) {
