...
@Component({
  selector: 'app-add-criquantitative-report',
  templateUrl: './add-criquantitative-report.component.html',
  styleUrls: ['./add-criquantitative-report.component.scss']
})
export class AddCriquantitativeReportComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<AddCriquantitativeReportComponent>,
  ...
  submitForm(){
    ...
    this.service.getUserWithUserId().subscribe((user: any) => {
      ...
      this.service.postData("/cri-quant/crh/"+user.crh.id, data).subscribe((res2: any) => {
