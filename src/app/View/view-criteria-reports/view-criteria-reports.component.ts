...
@Component({
  selector: 'app-view-criteria-reports',
  templateUrl: './view-criteria-reports.component.html',
  styleUrls: ['./view-criteria-reports.component.scss']
})
export class ViewCriteriaReportsComponent implements OnInit {
  course: any = null;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ViewCriteriaReportsComponent>,
