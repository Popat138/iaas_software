...
@Component({
  selector: 'app-view-biodata',
  templateUrl: './view-biodata.component.html',
  styleUrls: ['./view-biodata.component.scss']
})
export class ViewBiodataComponent implements OnInit {
...
subject:any=null;
  ...
  dataSource_rp!:MatTableDataSource<ViewBiodataComponent>;
  dataSource_st!:MatTableDataSource<ViewBiodataComponent>;
  constructor(
    ...
    public dialogref: MatDialogRef<ViewBiodataComponent>
  ) {
