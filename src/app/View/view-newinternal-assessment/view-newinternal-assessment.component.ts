...
@Component({
  selector: 'app-view-newinternal-assessment',
  templateUrl: './view-newinternal-assessment.component.html',
  styleUrls: ['./view-newinternal-assessment.component.scss']
})
export class ViewNewinternalAssessmentComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<ViewNewinternalAssessmentComponent>,
