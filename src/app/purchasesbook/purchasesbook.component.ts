...
@Component({
  selector: 'app-purchasesbook',
  templateUrl: './purchasesbook.component.html',
  styleUrls: ['./purchasesbook.component.scss']
})
export class PurchasesbookComponent implements OnInit {
  ...
  dataSource!:MatTableDataSource<PurchasesbookComponent>;
  ...
  addpgcourses(){
    const dialogRef = this.dialog.open(AddPurchasedBooksComponent ,{width: "80%",height: "86vh",panelClass: 'full-width-dialog'});
