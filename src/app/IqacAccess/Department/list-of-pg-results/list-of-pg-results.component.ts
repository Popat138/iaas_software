...
@Component({
  selector: 'app-list-of-pg-results',
  templateUrl: './list-of-pg-results.component.html',
  styleUrls: ['./list-of-pg-results.component.scss']
})
export class ListOfPgResultsComponent implements OnInit {
    ...
    displayedColumns2: string[] =['year','prog_name','students_addmitted','students_appear','students_pass',
    // 'edit_resultpg',
    'delete_resultpg'];
    ...
    resultspg_dataSource!:MatTableDataSource<ListOfPgResultsComponent>;
    ...
    fetchCommittee() {
      ...
      this.service.getData("/pg-result/college/"+user.college.id).subscribe((res: any) => {
        ...
        getPos.then((response: any) => {
                  ...
                  );console.table(this.resultspg_dataSource.data)
  
                  this.resultspg_dataSource.paginator = this.paginator;
