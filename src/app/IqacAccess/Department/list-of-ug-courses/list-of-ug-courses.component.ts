...
import { AddUgCoursesComponent } from 'src/app/Addnew/Department/add-ug-courses/add-ug-courses.component';
...
@Component({
  selector: 'app-list-of-ug-courses',
  templateUrl: './list-of-ug-courses.component.html',
  styleUrls: ['./list-of-ug-courses.component.scss']
})
export class ListOfUgCoursesComponent implements OnInit {
  ...
  dataSource!:MatTableDataSource<ListOfUgCoursesComponent>;
