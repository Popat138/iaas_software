...
import { AddAdmittedStudentsComponent } from 'src/app/Addnew/Department/add-admitted-students/add-admitted-students.component';
...
@Component({
  selector: 'app-list-of-research-students',
  templateUrl: './list-of-research-students.component.html',
  styleUrls: ['./list-of-research-students.component.scss']
})
export class ListOfResearchStudentsComponent implements OnInit {


  committee : any =null;
  displayedColumns: string[] = ['year','Programme','name_of_student','name_of_guide','category', 'date_of_registration','upload_cert',
  // 'edit',
  'delete'];

  dataSource!:MatTableDataSource<ListOfResearchStudentsComponent>;
