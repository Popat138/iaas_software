...
@Component({
  selector: 'app-list-of-scholarship',
  templateUrl: './list-of-scholarship.component.html',
  styleUrls: ['./list-of-scholarship.component.scss']
})
export class ListOfScholarshipComponent implements OnInit {
  ...
  displayedColumns: string[] = [
    ...
    committee : any = null;
    dataSource!:MatTableDataSource<ListOfScholarshipComponent>;
