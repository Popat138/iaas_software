...
@Component({
  selector: 'app-criteria1',
  templateUrl: './criteria1.component.html',
  styleUrls: ['./criteria1.component.scss']
})
export class Criteria1Component implements OnInit {
...
displayedColumns_qualN: string[] = [
  ...
  dataSource!:MatTableDataSource<Criteria1Component>;
  dataSource_pg!:MatTableDataSource<Criteria1Component>;
  dataSource_other!:MatTableDataSource<Criteria1Component>;
  dataSource_project!:MatTableDataSource<Criteria1Component>;
  internship_dataSource!:MatTableDataSource<Criteria1Component>;
  Acadamic_dataSource!:MatTableDataSource<Criteria1Component>;
  dataSource_qual!:MatTableDataSource<Criteria1Component>;
  dataSource_qualN!:MatTableDataSource<Criteria1Component>;
  dataSource_quanT!:MatTableDataSource<Criteria1Component>;
    ...
    this.service.getData(`/cri-qual`).subscribe((res: any) => {
      ...
      for (let i = 0; i < res.length; i++) {
        ...
        this.service.getData("/crh/" + res[i].crh.id).subscribe((result: any) => {
          if(res[i].crh.criteriaName=="Criterion-I")
          {finaldata.push(
            {
