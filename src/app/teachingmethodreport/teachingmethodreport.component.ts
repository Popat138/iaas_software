...
@Component({
  selector: 'app-teachingmethodreport',
  templateUrl: './teachingmethodreport.component.html',
  styleUrls: ['./teachingmethodreport.component.scss']
})
export class TeachingmethodreportComponent implements OnInit {
  test;
  photo;
  news;
  college;
  ...
  constructor(                                                        
    ...
    dataSource_pdp!:MatTableDataSource<TeachingmethodreportComponent>;
