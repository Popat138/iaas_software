...
export class CreateTeachersComponent implements OnInit {
  ...
  displayedColumns: string[] = [
    ...
    committee : any = null;
    dataSource!:MatTableDataSource<CreateTeachersComponent>;
  ...
  createteachers(){
    const dialogRef = this.dialog.open(AddTeachersComponent ,{width: "100vw",height: "90vh",panelClass: 'full-width-dialog'});
