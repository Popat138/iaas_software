...
@Component({
  selector: 'app-ilms-information',
  templateUrl: './ilms-information.component.html',
  styleUrls: ['./ilms-information.component.scss']
})
export class IlmsInformationComponent implements OnInit {
  ...
  dataSource!:MatTableDataSource<IlmsInformationComponent>;
