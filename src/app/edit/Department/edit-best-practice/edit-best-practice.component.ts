...
@Component({
  selector: 'app-edit-best-practice',
  templateUrl: './edit-best-practice.component.html',
  styleUrls: ['./edit-best-practice.component.scss']
})
export class EditBestPracticeComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<EditBestPracticeComponent>,
...
this.service.putData("/best-practice", data).subscribe((res: any) => {
  console.log(res);
