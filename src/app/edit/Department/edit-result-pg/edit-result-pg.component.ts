...
@Component({
  selector: 'app-edit-result-pg',
  templateUrl: './edit-result-pg.component.html',
  styleUrls: ['./edit-result-pg.component.scss']
})
export class EditResultPgComponent implements OnInit {
...
constructor(
  ...
  public rowdata : any,
  public dialogRef: MatDialogRef<EditResultPgComponent>,
...
this.service.putData("/pg-result", data).subscribe((res: any) => {
console.log(res);
}, (err: any) => {
