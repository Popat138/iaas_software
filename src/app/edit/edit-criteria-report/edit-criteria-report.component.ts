...
@Component({
  selector: 'app-edit-criteria-report',
  templateUrl: './edit-criteria-report.component.html',
  styleUrls: ['./edit-criteria-report.component.scss']
})
export class EditCriteriaReportComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogref: MatDialogRef<EditCriteriaReportComponent>,
  ...
  submitForm(){
    ...
    // this.service.getUserWithUserId().subscribe((user: any) => {
      ...
      this.service.putData(`/cri-qual`, data).subscribe((res2: any) => {
