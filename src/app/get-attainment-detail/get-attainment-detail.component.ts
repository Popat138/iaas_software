...
@Component({
  selector: 'app-get-attainment-detail',
  templateUrl: './get-attainment-detail.component.html',
  styleUrls: ['./get-attainment-detail.component.scss']
})
export class GetAttainmentDetailComponent implements OnInit {
