...
@Component({
  ...
  styleUrls: ['./pg-courses.component.scss']
})
export class PgCoursesComponent implements OnInit {


  committee : any =null;
  displayedColumns: string[] = ['pg_prog','code','year','sem','c_code','c_name','year_of_intro','prog_type','edit','delete'];

  dataSource!:MatTableDataSource<PgCoursesComponent>;
  ...
  fetchCommittee() {
    ...
    this.service.getUserWithUserId().subscribe((user : any) => {
     // console.log(user);
      this.service.getData("/course/programLevel/Postgraduate/department/" + user.hod.department.id).subscribe((res: any) => {
