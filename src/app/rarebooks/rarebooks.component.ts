...
@Component({
  selector: 'app-rarebooks',
  templateUrl: './rarebooks.component.html',
  styleUrls: ['./rarebooks.component.scss']
})
export class RarebooksComponent implements OnInit {
  ...
  dataSource!:MatTableDataSource<RarebooksComponent>;
  ...
  addpgcourses(){
    const dialogRef = this.dialog.open(AddRareBooksComponent ,{width: "80%",height: "86vh",panelClass: 'full-width-dialog'});
