...
@Component({
  selector: 'app-onlineresources',
  templateUrl: './onlineresources.component.html',
  styleUrls: ['./onlineresources.component.scss']
})
export class OnlineresourcesComponent implements OnInit {
  ...
  dataSource!:MatTableDataSource<OnlineresourcesComponent>;
