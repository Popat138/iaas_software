...
@Component({
  selector: 'app-get-roll-call-department',
  templateUrl: './get-roll-call-department.component.html',
  styleUrls: ['./get-roll-call-department.component.scss']
})
export class GetRollCallDepartmentComponent implements OnInit {
